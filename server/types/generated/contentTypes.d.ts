...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subs: Attribute.Component<'elements.achievement', true>;
...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cover: Attribute.Media;
    course_categories: Attribute.Relation<
      'api::course.course',
      'oneToMany',
...
export interface ApiCourseCategoryCourseCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::course-category.course-category', 'name'> &
      Attribute.Required;
    description: Attribute.Text;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    podcastCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    articleCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    facultyCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    whoweareCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    whatweteachCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    courseCover: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPodcastPodcast extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    description: Attribute.Text;
    slug: Attribute.UID<'api::podcast.podcast', 'title'>;
    cover: Attribute.Media;
    authorsBio: Attribute.Relation<
      'api::podcast.podcast',
      'manyToOne',
