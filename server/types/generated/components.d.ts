...
export interface ElementsAchievement extends Schema.Component {
  collectionName: 'components_elements_achievements';
  info: {
    displayName: 'achievement';
    description: '';
  };
  attributes: {
    achtitle: Attribute.String & Attribute.Required;
    achdesc: Attribute.String;
  };
}
...
export interface LayoutLogo extends Schema.Component {
  ...
  attributes: {
    ...
    plainLogo: Attribute.Media & Attribute.Required;
  };
}
...
export interface LinksSocialLink extends Schema.Component {
  ...
  attributes: {
    ...
    social: Attribute.Enumeration<
      ['YOUTUBE', 'TWITTER', 'INSTAGRAM', 'FACEBOOK', 'MAIL', 'GPLUS']
    >;
  };
}
...
export interface SectionsAbout extends Schema.Component {
  ...
  attributes: {
    ...
    competencies: Attribute.JSON;
    heading2: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Core Competencies'>;
    picture2: Attribute.Media;
  };
}
...
export interface SectionsCompetencies extends Schema.Component {
  collectionName: 'components_sections_competencies';
  info: {
    displayName: 'Competencies';
    description: '';
  };
  attributes: {
    competency: Attribute.Component<'elements.feature', true>;
    heading: Attribute.String & Attribute.Required;
    corecompetencies: Attribute.JSON;
  };
}
...
export interface SectionsTabs extends Schema.Component {
  ...
  attributes: {
    theHolyScriptures: Attribute.RichText;
    god: Attribute.RichText;
    man: Attribute.RichText;
    salvation: Attribute.RichText;
    church: Attribute.RichText;
    angels: Attribute.RichText;
    lastThings: Attribute.RichText;
    picture: Attribute.Media;
    beliefs: Attribute.JSON;
  };
}
...
export interface SectionsWho extends Schema.Component {
  collectionName: 'components_sections_whos';
  info: {
    displayName: 'Who';
    description: '';
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      'elements.achievement': ElementsAchievement;
      ...
      'sections.competencies': SectionsCompetencies;
